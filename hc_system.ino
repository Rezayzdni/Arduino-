...
void loop(void) {
   ...
   boolean heater_high = false;
	   ...
	   if(avgH<80 && humidity_state ==0){
		  ...
		  humidifier_low = 1;
		  humidifier_high = 0;
		    //Serial.println("HUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUU");
	    }
	 ...
	 //check cooler
	      ...
	      if(HC_super_state == 0 || coolerIsOn){
		   ...
		   //  Serial.print("state cooler:            ");
		    // Serial.println(cooler_state);
		 ...
		 coolerIsOn = true;
			...
			cooler_low = 1;
			cooler_high = 0;
			//Serial.println("COOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO");
		  ...
		  if(avgT < 28 && cooler_state == 1){
	       ...
	       //check heater
			...
			heater_state = 1;
			      heater_low = 1;
			      heater_high = 0;
			//Serial.println("HEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEE");
			      }
